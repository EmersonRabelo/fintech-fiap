		...
		<div class="result">
			<table class="result-table table table-hover ">
				...
				<c:forEach items="${expenses}" var="expenses">
		            <tr scope="row">
		                <td colspan="2">${expenses.name}</td>
		                <td><fmt:formatNumber value = "${expenses.value}" type = "currency"/>  </td>
		                <td>
		                	<div class="dropdown">
		                	<span class="btn material-symbols-outlined" type="button" id="tableMore" data-bs-toggle="dropdown" aria-expanded="false">
							  ...
							  <ul class="dropdown-menu" aria-labelledby="tableMore">
							    <li>
				                	<button class="dropdown-item" onclick="alterarItem(${expenses.id})">
				                		Alterar
				                	</button>
							    </li>
							    <li>
				                	<button class="dropdown-item" onclick="excluirItem(${expenses.id})">
				                		Excluir
				                	</button>
							    </li>
							  </ul>
	  ...
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="staticBackdropLabel">Alterar despesa</h5>
	        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	      </div>
	      <div class="modal-body">
	        <div class="input-group mb-3">
			  <input type="text" class="form-control" id="changeExpenseTitleINPUT" placeholder="Título" aria-label="Título da entrada" aria-describedby="changeIncomeTitle">
			  <span class="input-group-text" id="changeIncomeTitle">Título</span>
			</div>
			<div class="input-group mb-3">
			  <span class="input-group-text">R$</span>
			  <input type="number" class="form-control" aria-label="Valor (em reais)" id="changeExpenseValue">
	...
	<div class="modal fade" id="addItemModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <div class="input-group mb-3">
			  <input type="text" class="form-control" id="addExpenseTitleINPUT" aria-label="Título da entrada" aria-describedby="changeExpenseTitle">
			  <span class="input-group-text" id="addExpenseTitle">Título</span>
			</div>
			<div class="input-group mb-3">
			  <span class="input-group-text">R$</span>
			  <input type="number" class="form-control" aria-label="Valor (em reais)" id="addExpenseValue">
			  <span class="input-group-text">Valor</span>
			</div>
			  <div class="col-auto">
		...
		<script defer src="./assets/js/expense.js"></script>
	</body>
</html>